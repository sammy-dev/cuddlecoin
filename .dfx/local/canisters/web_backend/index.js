...
import { idlFactory } from './web_backend.did.js';
export { idlFactory } from './web_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_WEB_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./web_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the web_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./web_backend.did.js")._SERVICE>}
 */
export const web_backend = createActor(canisterId);
