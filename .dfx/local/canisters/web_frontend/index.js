...
import { idlFactory } from './web_frontend.did.js';
export { idlFactory } from './web_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_WEB_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./web_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the web_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./web_frontend.did.js")._SERVICE>}
 */
export const web_frontend = createActor(canisterId);
